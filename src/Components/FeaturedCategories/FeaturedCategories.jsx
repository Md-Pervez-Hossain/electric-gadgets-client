  ...
  return (
    <div className="">
      ...
      <div className="grid md:grid-cols-2 gap-4 ">
        <div className=" relative  shadow-lg p-4 text-transparent hover:text-white duration-500 ease-in-out ">
          <img
            src="https://c8.alamy.com/comp/H7AAG1/young-man-with-shopping-bags-H7AAG1.jpg"
            alt=""
            className="w-full h-full cursor-pointer hover:brightness-50 duration-500 ease-in-out  "
          />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
            <h2 className="text-4xl  z-30">Life Style</h2>
          </div>
        </div>

        <div className=" grid grid-cols-2 gap-4">
          <div className=" relative shadow-lg p-4  cursor-pointer text-transparent hover:text-white duration-500 ease-in-out ">
            <img
              src="https://static.mercusys.com/product-image/1_normal20221108011748.jpg"
              alt=""
              className="h-full w-full hover:brightness-50 duration-500 ease-in-out  "
            />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
              <h2 className="text-4xl  z-30">Wifi Router</h2>
            </div>
          </div>
          <div className=" relative shadow-lg p-4 cursor-pointer text-transparent hover:text-white duration-500 ease-in-out  ">
            <img
          ...
          <div className=" relative  shadow-lg p-4 cursor-pointer text-transparent hover:text-white duration-500 ease-in-out ">
            ...
            />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
              <h2 className="text-4xl z-30">Scanner</h2>
            </div>
          </div>
          <div className=" relative shadow-lg p-4 cursor-pointer text-transparent hover:text-white duration-500 ease-in-out ">
            <img
            ...
            />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
              <h2 className="text-4xl  z-30">Mobile</h2>
            </div>
          </div>
        </div>
      </div>
